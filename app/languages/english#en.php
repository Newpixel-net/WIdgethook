...
return [
    ...
    'global.custom_css_placeholder' => '#notification_%s { font-weight: bold !important; }',
    ...
    'campaigns.domain_placeholder' => 'e.g. domain.com or subdomain.domain.com',
    ...
    'campaigns_import.breadcrumb' => 'Import campaigns',
    'campaigns_import.title' => 'Import campaigns',
    'campaigns_import.menu' => 'Import campaigns',
    'campaigns_import.header' => 'Import campaigns',
    ...
    'notification.settings.translation' => 'Translation here...',
    ...
    'notification.settings.live_counter_help' => 'Use <code>{COUNTER}</code> to display the counter wherever you need.',
    ...
    'notification.settings.video' => 'Video URL',
    ...
    'notification.settings.url_new_tab' => 'On click, open in new tab',
    ...
    'notification.settings.trigger_type_exact_placeholder' => 'Full URL - e.g. https://domain.com',
    'notification.settings.trigger_type_not_exact_placeholder' => 'Full URL - e.g. https://domain.com',
    'notification.settings.trigger_type_contains_placeholder' => 'Part of the URL - e.g. /product/12345',
    'notification.settings.trigger_type_not_contains_placeholder' => 'Part of the URL - e.g. /product/12345',
    'notification.settings.trigger_type_starts_with_placeholder' => 'Part of the URL - e.g. https://domain.com/product',
    'notification.settings.trigger_type_not_starts_with_placeholder' => 'Part of the URL - e.g. https://domain.com/product',
    'notification.settings.trigger_type_ends_with_placeholder' => 'Part of the URL - e.g. /product/12345',
    'notification.settings.trigger_type_not_ends_with_placeholder' => 'Part of the URL - e.g. /product/12345',
    ...
    'notification.settings.display_duration_help' => 'Set -1 to display indefinitely or until manually closed.',
    ...
    'notification.settings.dark_mode' => 'Dark mode',
    'notification.settings.dark_mode_is_enabled' => 'Enable dark mode',
    'notification.settings.dark_mode_is_enabled_help' => 'Display a different color theme when the end user device dark mode is enabled.',
    'notification.settings.advanced' => 'Advanced',
    ...
    'notification.settings.data_info' => 'All caught data will also be recorded in the Data section of this notification.',
    ...
    'notification.statistics.path' => 'Path',
    'notification.statistics.total' => 'Total',
    ...
    'notification.informational.title_default' => 'Trusted by thousands.',
    'notification.informational.description_default' => 'Join over <span style="font-weight: bold">5,000 users</span> on our platform.',
    'notification.informational.image_default' => ASSETS_FULL_URL . 'images/notifications/informational.svg',
    ...
    'notification.coupon.description_default' => 'Copy & use the coupon below',
    ...
    'notification.live_counter.description_default' => '<span style="font-weight:700;">{COUNTER}</span> active visitors 🚀',
    ...
    'notification.request_collector.input_placeholder_default' => '+1 234 567 8901',
    ...
    'notification.countdown_collector.title_default' => 'Summer sale 🏷️',
    'notification.countdown_collector.description_default' => 'Be the first one to get notified.',
    'notification.countdown_collector.content_title_default' => '',
    'notification.countdown_collector.input_placeholder_default' => 'hello@example.com',
    ...
    'notification.custom_html.html_default' => '<span style="color: white;mix-blend-mode: difference;">Your custom HTML content right here.</span>',
    ...
    'notification.collector_bar.input_placeholder_default' => 'hello@example.com',
    ...
    'notification.collector_modal.input_placeholder_default' => 'hello@example.com',
    ...
    'notification.collector_two_modal.input_placeholder_default' => 'hello@example.com',
    ...
    'notification.text_feedback.input_placeholder_default' => 'Your honest feedback',
    ...
    'api_documentation.notifications_translations_help' => 'Available for all the marked for translation fields.',
    'api_documentation.notifications_translations_translatable' => 'Translatable',
