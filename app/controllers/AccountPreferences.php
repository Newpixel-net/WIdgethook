...
class AccountPreferences extends Controller {
    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            /* Custom */
            $_POST['campaigns_default_order_by'] = isset($_POST['campaigns_default_order_by']) && in_array($_POST['campaigns_default_order_by'], ['campaign_id', 'last_datetime', 'datetime', 'name', 'domain',]) ? $_POST['campaigns_default_order_by'] : 'campaign_id';
            $_POST['notifications_default_order_by'] = isset($_POST['notifications_default_order_by']) && in_array($_POST['notifications_default_order_by'], ['notification_id', 'last_datetime', 'name', 'datetime', 'impressions', 'hovers', 'clicks', 'form_submissions']) ? $_POST['notifications_default_order_by'] : 'notification_id';
            ...
            if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
                ...
                $preferences = json_encode([
                    ...
                    'notifications_default_order_by' => $_POST['notifications_default_order_by'],
