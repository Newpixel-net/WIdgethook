...
<script>
    ...
    /* Light mode */
    init_color_pickr('#settings_title_color', '#settings_title_color_pickr', '.altumcode-informational-title', 'color', 'light', 'title');
    init_color_pickr('#settings_description_color', '#settings_description_color_pickr', '.altumcode-informational-description', 'color', 'light', 'description');
    ...
    /* Dark mode */
    init_color_pickr('#dark_mode_title_color', '#dark_mode_title_color_pickr', '.altumcode-informational-title', 'color', 'dark', 'title');
    init_color_pickr('#dark_mode_description_color', '#dark_mode_description_color_pickr', '.altumcode-informational-description', 'color', 'dark', 'description');
