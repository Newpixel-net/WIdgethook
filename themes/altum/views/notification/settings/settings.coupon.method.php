...
<script>
    ...
    /* Light mode */
    init_color_pickr('#settings_title_color', '#settings_title_color_pickr', '.altumcode-coupon-title', 'color', 'light', 'title');
    init_color_pickr('#settings_description_color', '#settings_description_color_pickr', '.altumcode-coupon-description', 'color', 'light', 'description');
    ...
    init_color_pickr('#settings_button_background_color', '#settings_button_background_color_pickr', '.altumcode-coupon-button', 'background-color', 'light', 'button_background');
    init_color_pickr('#settings_button_color', '#settings_button_color_pickr', '.altumcode-coupon-button', 'color', 'light', 'button');

    /* Dark mode */
    init_color_pickr('#dark_mode_title_color', '#dark_mode_title_color_pickr', '.altumcode-coupon-title', 'color', 'dark', 'title');
    init_color_pickr('#dark_mode_description_color', '#dark_mode_description_color_pickr', '.altumcode-coupon-description', 'color', 'dark', 'description');
    ...
    init_color_pickr('#dark_mode_button_background_color', '#dark_mode_button_background_color_pickr', '.altumcode-coupon-button', 'background-color', 'dark', 'button_background');
    init_color_pickr('#dark_mode_button_color', '#dark_mode_button_color_pickr', '.altumcode-coupon-button', 'color', 'dark', 'button');
</script>
