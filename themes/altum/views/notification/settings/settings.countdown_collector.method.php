...
<div class="form-group">
    <label for="settings_time_color"><i class="fas fa-fw fa-sm fa-palette text-muted mr-1"></i> <?= l('notification.settings.time_color') ?></label>
...
<div class="form-group">
    <label for="settings_time_background_color"><i class="fas fa-fw fa-sm fa-palette text-muted mr-1"></i> <?= l('notification.settings.time_background_color') ?></label>
...
<div class="collapse" data-parent="#tab_customize" id="dark_mode_container">
    ...
    <div class="form-group">
        <label for="dark_mode_time_color"><i class="fas fa-fw fa-sm fa-palette text-muted mr-1"></i> <?= l('notification.settings.time_color') ?></label>
        <input type="hidden" id="dark_mode_time_color" name="dark_mode_time_color" class="form-control" value="<?= $data->notification->settings->dark_mode_time_color ?>" />
        <div id="dark_mode_time_color_pickr"></div>
    </div>

    <div class="form-group">
        <label for="dark_mode_time_background_color"><i class="fas fa-fw fa-sm fa-palette text-muted mr-1"></i> <?= l('notification.settings.time_background_color') ?></label>
        <input type="hidden" id="dark_mode_time_background_color" name="dark_mode_time_background_color" class="form-control" value="<?= $data->notification->settings->dark_mode_time_background_color ?>" />
        <div id="dark_mode_time_background_color_pickr"></div>
    </div>
...
<script>
    ...
    /* Light mode init_color_pickr */
    init_color_pickr('#settings_title_color', '#settings_title_color_pickr', '.altumcode-countdown-collector-title', 'color', 'light', 'title');
    init_color_pickr('#settings_description_color', '#settings_description_color_pickr', '.altumcode-countdown-collector-description', 'color', 'light', 'description');
    init_color_pickr('#settings_content_title_color', '#settings_content_title_color_pickr', '.altumcode-countdown-collector-content-title', 'color', 'light', 'content_title');
    init_color_pickr('#settings_time_color', '#settings_time_color_pickr', '.altumcode-countdown-collector-time', 'color', 'light', 'time');
    init_color_pickr('#settings_time_background_color', '#settings_time_background_color_pickr', '.altumcode-countdown-collector-time', 'background', 'light', 'time_background');
    ...
    init_color_pickr('#settings_button_background_color', '#settings_button_background_color_pickr', '.altumcode-countdown-collector-form button', 'background-color', 'light', 'button_background');
    init_color_pickr('#settings_button_color', '#settings_button_color_pickr', '.altumcode-countdown-collector-form button', 'color', 'light', 'button');

    /* Dark mode init_color_pickr */
    init_color_pickr('#dark_mode_title_color', '#dark_mode_title_color_pickr', '.altumcode-countdown-collector-title', 'color', 'dark', 'title');
    init_color_pickr('#dark_mode_description_color', '#dark_mode_description_color_pickr', '.altumcode-countdown-collector-description', 'color', 'dark', 'description');
    init_color_pickr('#dark_mode_content_title_color', '#dark_mode_content_title_color_pickr', '.altumcode-countdown-collector-content-title', 'color', 'dark', 'content_title');
    init_color_pickr('#dark_mode_time_color', '#dark_mode_time_color_pickr', '.altumcode-countdown-collector-time', 'color', 'dark', 'time');
    init_color_pickr('#dark_mode_time_background_color', '#dark_mode_time_background_color_pickr', '.altumcode-countdown-collector-time', 'background', 'dark', 'time_background');
    ...
    init_color_pickr('#dark_mode_button_background_color', '#dark_mode_button_background_color_pickr', '.altumcode-countdown-collector-form button', 'background-color', 'dark', 'button_background');
    init_color_pickr('#dark_mode_button_color', '#dark_mode_button_color_pickr', '.altumcode-countdown-collector-form button', 'color', 'dark', 'button');
</script>
