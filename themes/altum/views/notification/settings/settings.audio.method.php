...
<script>
    ...
    /* light mode */
    init_color_pickr('#settings_title_color', '#settings_title_color_pickr', '.altumcode-audio-title', 'color', 'light', 'title');
    ...
    init_color_pickr('#settings_button_background_color', '#settings_button_background_color_pickr', '.altumcode-audio-button', 'background-color', 'light', 'button_background');
    init_color_pickr('#settings_button_color', '#settings_button_color_pickr', '.altumcode-audio-button', 'color', 'light', 'button');

    /* dark mode */
    init_color_pickr('#dark_mode_title_color', '#dark_mode_title_color_pickr', '.altumcode-audio-title', 'color', 'dark', 'title');
    ...
    init_color_pickr('#dark_mode_button_background_color', '#dark_mode_button_background_color_pickr', '.altumcode-audio-button', 'background-color', 'dark', 'button_background');
    init_color_pickr('#dark_mode_button_color', '#dark_mode_button_color_pickr', '.altumcode-audio-button', 'color', 'dark', 'button');
