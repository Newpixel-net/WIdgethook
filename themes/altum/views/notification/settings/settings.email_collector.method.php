...
<div class="form-group">
    <label for="settings_name_placeholder"><i class="fas fa-fw fa-sm fa-user text-muted mr-1"></i> <?= l('notification.settings.name_placeholder') ?></label>
    <div class="input-group">
        <input type="text" id="settings_name_placeholder" name="name_placeholder" class="form-control" value="<?= e($data->notification->settings->name_placeholder) ?>" maxlength="128" />
        <div class="input-group-append">
            <button class="btn btn-dark font-size-small" type="button" data-toggle="collapse" data-target="#name_placeholder_translate_container" aria-expanded="false" aria-controls="name_placeholder_translate_container" data-tooltip title="<?= l('global.translate') ?>" data-tooltip-hide-on-click><i class="fas fa-fw fa-sm fa-language"></i></button>
        </div>
    </div>
</div>

<div class="collapse" id="name_placeholder_translate_container" data-translation-container="name_placeholder">
    <?= htmlspecialchars(json_encode($data->notification->settings->translations->name_placeholder ?? ''), ENT_QUOTES, 'UTF-8') ?>
</div>

<div class="form-group">
    <label for="settings_email_placeholder"><i class="fas fa-fw fa-sm fa-envelope text-muted mr-1"></i> <?= l('notification.settings.email_placeholder') ?></label>
    <div class="input-group">
        <input type="text" id="settings_email_placeholder" name="email_placeholder" class="form-control" value="<?= e($data->notification->settings->email_placeholder) ?>" maxlength="128" />
        <div class="input-group-append">
            <button class="btn btn-dark font-size-small" type="button" data-toggle="collapse" data-target="#email_placeholder_translate_container" aria-expanded="false" aria-controls="email_placeholder_translate_container" data-tooltip title="<?= l('global.translate') ?>" data-tooltip-hide-on-click><i class="fas fa-fw fa-sm fa-language"></i></button>
        </div>
    </div>
</div>

<div class="collapse" id="email_placeholder_translate_container" data-translation-container="email_placeholder">
    <?= htmlspecialchars(json_encode($data->notification->settings->translations->email_placeholder ?? ''), ENT_QUOTES, 'UTF-8') ?>
</div>
...
<script>
    ...
    /* Light mode */
    init_color_pickr('#settings_title_color', '#settings_title_color_pickr', '.altumcode-email-collector-title', 'color', 'light', 'title');
    init_color_pickr('#settings_description_color', '#settings_description_color_pickr', '.altumcode-email-collector-description', 'color', 'light', 'description');
    ...
    init_color_pickr('#settings_button_background_color', '#settings_button_background_color_pickr', '.altumcode-email-collector-button', 'background-color', 'light', 'button_background');
    init_color_pickr('#settings_button_color', '#settings_button_color_pickr', '.altumcode-email-collector-button', 'color', 'light', 'button');

    /* Dark mode */
    init_color_pickr('#dark_mode_title_color', '#dark_mode_title_color_pickr', '.altumcode-email-collector-title', 'color', 'dark', 'title');
    init_color_pickr('#dark_mode_description_color', '#dark_mode_description_color_pickr', '.altumcode-email-collector-description', 'color', 'dark', 'description');
    ...
    init_color_pickr('#dark_mode_button_background_color', '#dark_mode_button_background_color_pickr', '.altumcode-email-collector-button', 'background-color', 'dark', 'button_background');
    init_color_pickr('#dark_mode_button_color', '#dark_mode_button_color_pickr', '.altumcode-email-collector-button', 'color', 'dark', 'button');
</script>
