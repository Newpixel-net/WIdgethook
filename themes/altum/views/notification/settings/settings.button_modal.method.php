...
<script>
    ...
    /* light mode */
    init_color_pickr('#settings_title_color', '#settings_title_color_pickr', '.altumcode-button-modal-title', 'color', 'light', 'title');
    init_color_pickr('#settings_description_color', '#settings_description_color_pickr', '.altumcode-button-modal-description', 'color', 'light', 'description');
    ...
    init_color_pickr('#settings_button_background_color', '#settings_button_background_color_pickr', '.altumcode-button-modal-button', 'background-color', 'light', 'button_background');
    init_color_pickr('#settings_button_color', '#settings_button_color_pickr', '.altumcode-button-modal-button', 'color', 'light', 'button');

    /* dark mode */
    init_color_pickr('#dark_mode_title_color', '#dark_mode_title_color_pickr', '.altumcode-button-modal-title', 'color', 'dark', 'title');
    init_color_pickr('#dark_mode_description_color', '#dark_mode_description_color_pickr', '.altumcode-button-modal-description', 'color', 'dark', 'description');
    ...
    init_color_pickr('#dark_mode_button_background_color', '#dark_mode_button_background_color_pickr', '.altumcode-button-modal-button', 'background-color', 'dark', 'button_background');
    init_color_pickr('#dark_mode_button_color', '#dark_mode_button_color_pickr', '.altumcode-button-modal-button', 'color', 'dark', 'button');
</script>
