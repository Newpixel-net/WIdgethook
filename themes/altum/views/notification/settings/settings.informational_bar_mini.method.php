...
<script>
    ...
    $('#settings_title').on('change paste keyup', event => {
        $('#notification_preview .altumcode-informational-bar-mini-title').text($(event.currentTarget).val());
    });

    $('#settings_image').on('change paste keyup', event => {
        $('#notification_preview .altumcode-informational-bar-mini-image').attr('src', $(event.currentTarget).val());
    });
    ...
    document.querySelector('#image').addEventListener('change', event => {
        ...
        if(file) {
            ...
            reader.onload = function(e) {
                $('#notification_preview .altumcode-informational-bar-mini-image').attr('src', e.target.result);
            };
    ...
    /* light mode */
    init_color_pickr('#settings_title_color', '#settings_title_color_pickr', '.altumcode-informational-bar-mini-title', 'color', 'light', 'title');
    ...
    /* dark mode */
    init_color_pickr('#dark_mode_title_color', '#dark_mode_title_color_pickr', '.altumcode-informational-bar-mini-title', 'color', 'dark', 'title');
