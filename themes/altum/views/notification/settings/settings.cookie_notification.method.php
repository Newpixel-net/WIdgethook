...
<div class="form-group">
    <label for="settings_url_text"><i class="fas fa-fw fa-sm fa-pen text-muted mr-1"></i> <?= l('notification.settings.url_link_text') ?></label>
    <div class="input-group">
        <input type="text" id="settings_url_text" name="url_text" class="form-control" value="<?= e($data->notification->settings->url_text) ?>" maxlength="256" />
        <div class="input-group-append">
            <button class="btn btn-dark font-size-small" type="button" data-toggle="collapse" data-target="#url_text_translate_container" aria-expanded="false" aria-controls="url_text_translate_container" data-tooltip title="<?= l('global.translate') ?>" data-tooltip-hide-on-click><i class="fas fa-fw fa-sm fa-language"></i></button>
        </div>
    </div>
</div>

<div class="collapse" id="url_text_translate_container" data-translation-container="url_text">
    <?= htmlspecialchars(json_encode($data->notification->settings->translations->url_text ?? ''), ENT_QUOTES, 'UTF-8') ?>
</div>
...
<script>
    ...
    /* Light mode */
    init_color_pickr('#settings_description_color', '#settings_description_color_pickr', '.altumcode-cookie-notification-description', 'color', 'light', 'description');
    ...
    init_color_pickr('#settings_button_background_color', '#settings_button_background_color_pickr', '.altumcode-cookie-notification-button', 'background-color', 'light', 'button_background');
    init_color_pickr('#settings_button_color', '#settings_button_color_pickr', '.altumcode-cookie-notification-button', 'color', 'light', 'button');

    /* Dark mode */
    init_color_pickr('#dark_mode_description_color', '#dark_mode_description_color_pickr', '.altumcode-cookie-notification-description', 'color', 'dark', 'description');
    ...
    init_color_pickr('#dark_mode_button_background_color', '#dark_mode_button_background_color_pickr', '.altumcode-cookie-notification-button', 'background-color', 'dark', 'button_background');
    init_color_pickr('#dark_mode_button_color', '#dark_mode_button_color_pickr', '.altumcode-cookie-notification-button', 'color', 'dark', 'button');
</script>
