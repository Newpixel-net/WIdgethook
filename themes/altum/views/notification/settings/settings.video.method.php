...
<script>
    ...
    //* light mode inits */
    init_color_pickr('#settings_title_color', '#settings_title_color_pickr', '.altumcode-video-title', 'color', 'light', 'title');
    ...
    init_color_pickr('#settings_button_background_color', '#settings_button_background_color_pickr', '.altumcode-video-button', 'background-color', 'light', 'button_background');
    init_color_pickr('#settings_button_color', '#settings_button_color_pickr', '.altumcode-video-button', 'color', 'light', 'button');

    /* dark mode inits */
    init_color_pickr('#dark_mode_title_color', '#dark_mode_title_color_pickr', '.altumcode-video-title', 'color', 'dark', 'title');
    ...
    init_color_pickr('#dark_mode_button_background_color', '#dark_mode_button_background_color_pickr', '.altumcode-video-button', 'background-color', 'dark', 'button_background');
    init_color_pickr('#dark_mode_button_color', '#dark_mode_button_color_pickr', '.altumcode-video-button', 'color', 'dark', 'button');
