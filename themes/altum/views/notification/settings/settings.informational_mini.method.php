...
<script>
    ...
    /* light mode */
    init_color_pickr('#settings_title_color', '#settings_title_color_pickr', '.altumcode-informational-mini-title', 'color', 'light', 'title');
    ...
    /* dark mode */
    init_color_pickr('#dark_mode_title_color', '#dark_mode_title_color_pickr', '.altumcode-informational-mini-title', 'color', 'dark', 'title');
