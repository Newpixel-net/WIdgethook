...
<div class="form-group">
    <label for="settings_content_title"><i class="fas fa-fw fa-sm fa-italic text-muted mr-1"></i> <?= l('notification.settings.content_title') ?></label>
    <div class="input-group">
        <input type="text" id="settings_content_title" name="content_title" class="form-control" value="<?= e($data->notification->settings->content_title) ?>" maxlength="256" />
        <div class="input-group-append">
            <button class="btn btn-dark font-size-small" type="button" data-toggle="collapse" data-target="#content_title_translate_container" aria-expanded="false" aria-controls="content_title_translate_container" data-tooltip title="<?= l('global.translate') ?>" data-tooltip-hide-on-click><i class="fas fa-fw fa-sm fa-language"></i></button>
        </div>
    </div>
</div>

<div class="collapse" id="content_title_translate_container" data-translation-container="content_title">
    <?= htmlspecialchars(json_encode($data->notification->settings->translations->content_title ?? ''), ENT_QUOTES, 'UTF-8') ?>
</div>

<div class="form-group">
    <label for="settings_content_description"><i class="fas fa-fw fa-sm fa-align-left text-muted mr-1"></i> <?= l('notification.settings.content_description') ?></label>
    <div class="input-group">
        <input type="text" id="settings_content_description" name="content_description" class="form-control" value="<?= e($data->notification->settings->content_description) ?>" maxlength="512" />
        <div class="input-group-append">
            <button class="btn btn-dark font-size-small" type="button" data-toggle="collapse" data-target="#content_description_translate_container" aria-expanded="false" aria-controls="content_description_translate_container" data-tooltip title="<?= l('global.translate') ?>" data-tooltip-hide-on-click><i class="fas fa-fw fa-sm fa-language"></i></button>
        </div>
    </div>
</div>

<div class="collapse" id="content_description_translate_container" data-translation-container="content_description">
    <?= htmlspecialchars(json_encode($data->notification->settings->translations->content_description ?? ''), ENT_QUOTES, 'UTF-8') ?>
</div>
...
<div class="form-group">
    <label for="settings_content_title_color"><i class="fas fa-fw fa-sm fa-palette text-muted mr-1"></i> <?= l('notification.settings.content_title_color') ?></label>
...
<div class="form-group">
    <label for="settings_content_description_color"><i class="fas fa-fw fa-sm fa-palette text-muted mr-1"></i> <?= l('notification.settings.content_description_color') ?></label>
...
<div class="collapse" data-parent="#tab_customize" id="dark_mode_container">
    ...
    <div class="form-group">
        <label for="dark_mode_content_title_color"><i class="fas fa-fw fa-sm fa-palette text-muted mr-1"></i> <?= l('notification.settings.content_title_color') ?></label>
        <input type="hidden" id="dark_mode_content_title_color" name="dark_mode_content_title_color" class="form-control" value="<?= $data->notification->settings->dark_mode_content_title_color ?>" />
        <div id="dark_mode_content_title_color_pickr"></div>
    </div>

    <div class="form-group">
        <label for="dark_mode_content_description_color"><i class="fas fa-fw fa-sm fa-palette text-muted mr-1"></i> <?= l('notification.settings.content_description_color') ?></label>
        <input type="hidden" id="dark_mode_content_description_color" name="dark_mode_content_description_color" class="form-control" value="<?= $data->notification->settings->dark_mode_content_description_color ?>" />
        <div id="dark_mode_content_description_color_pickr"></div>
    </div>
...
<script>
    ...
    /* light mode */
    init_color_pickr('#settings_title_color', '#settings_title_color_pickr', '.altumcode-request-collector-title', 'color', 'light', 'title');
    init_color_pickr('#settings_description_color', '#settings_description_color_pickr', '.altumcode-request-collector-description', 'color', 'light', 'description');
    init_color_pickr('#settings_content_title_color', '#settings_content_title_color_pickr', '.altumcode-request-collector-content-title', 'color', 'light', 'content_title');
    init_color_pickr('#settings_content_description_color', '#settings_content_description_color_pickr', '.altumcode-request-collector-content-description', 'color', 'light', 'content_description');
    ...
    init_color_pickr('#settings_button_background_color', '#settings_button_background_color_pickr', '.altumcode-request-collector-row button', 'background-color', 'light', 'button_background');
    init_color_pickr('#settings_button_color', '#settings_button_color_pickr', '.altumcode-request-collector-row button', 'color', 'light', 'button');

    /* dark mode */
    init_color_pickr('#dark_mode_title_color', '#dark_mode_title_color_pickr', '.altumcode-request-collector-title', 'color', 'dark', 'title');
    init_color_pickr('#dark_mode_description_color', '#dark_mode_description_color_pickr', '.altumcode-request-collector-description', 'color', 'dark', 'description');
    init_color_pickr('#dark_mode_content_title_color', '#dark_mode_content_title_color_pickr', '.altumcode-request-collector-content-title', 'color', 'dark', 'content_title');
    init_color_pickr('#dark_mode_content_description_color', '#dark_mode_content_description_color_pickr', '.altumcode-request-collector-content-description', 'color', 'dark', 'content_description');
    ...
    init_color_pickr('#dark_mode_button_background_color', '#dark_mode_button_background_color_pickr', '.altumcode-request-collector-row button', 'background-color', 'dark', 'button_background');
    init_color_pickr('#dark_mode_button_color', '#dark_mode_button_color_pickr', '.altumcode-request-collector-row button', 'color', 'dark', 'button');
</script>
