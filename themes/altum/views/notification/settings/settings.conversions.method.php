...
<script>
    ...
    init_color_pickr('#settings_title_color', '#settings_title_color_pickr', '.altumcode-conversions-title', 'color', 'light', 'title');
    init_color_pickr('#settings_description_color', '#settings_description_color_pickr', '.altumcode-conversions-description', 'color', 'light', 'description');
    init_color_pickr('#settings_date_color', '#settings_date_color_pickr', '.altumcode-conversions-time', 'color', 'light', 'date');
    ...
    init_color_pickr('#dark_mode_title_color', '#dark_mode_title_color_pickr', '.altumcode-conversions-title', 'color', 'dark', 'title');
    init_color_pickr('#dark_mode_description_color', '#dark_mode_description_color_pickr', '.altumcode-conversions-description', 'color', 'dark', 'description');
    init_color_pickr('#dark_mode_date_color', '#dark_mode_date_color_pickr', '.altumcode-conversions-time', 'color', 'dark', 'date');
