...
<script>
    ...
    /* light mode init */
    init_color_pickr('#settings_title_color', '#settings_title_color_pickr', '.altumcode-social-share-title', 'color', 'light', 'title');
    init_color_pickr('#settings_description_color', '#settings_description_color_pickr', '.altumcode-social-share-description', 'color', 'light', 'description');
    ...
    /* dark mode init */
    init_color_pickr('#dark_mode_title_color', '#dark_mode_title_color_pickr', '.altumcode-social-share-title', 'color', 'dark', 'title');
    init_color_pickr('#dark_mode_description_color', '#dark_mode_description_color_pickr', '.altumcode-social-share-description', 'color', 'dark', 'description');
