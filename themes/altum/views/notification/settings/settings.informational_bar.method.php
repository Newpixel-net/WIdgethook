...
<script>
    ...
    /* Light mode init */
    init_color_pickr('#settings_title_color', '#settings_title_color_pickr', '.altumcode-informational-bar-title', 'color', 'light', 'title');
    init_color_pickr('#settings_description_color', '#settings_description_color_pickr', '.altumcode-informational-bar-description', 'color', 'light', 'description');
    ...
    /* Dark mode init */
    init_color_pickr('#dark_mode_title_color', '#dark_mode_title_color_pickr', '.altumcode-informational-bar-title', 'color', 'dark', 'title');
    init_color_pickr('#dark_mode_description_color', '#dark_mode_description_color_pickr', '.altumcode-informational-bar-description', 'color', 'dark', 'description');
