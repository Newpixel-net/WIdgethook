...
<div class="form-group">
    ...
    <small class="form-text text-muted"><?= l('notification.settings.live_counter_help') ?></small>
...
<div class="form-group">
    <label for="settings_pulse_background_color"><i class="fas fa-fw fa-sm fa-palette text-muted mr-1"></i> <?= l('notification.settings.pulse_background_color') ?></label>
...
<div class="collapse" data-parent="#tab_customize" id="dark_mode_container">
    ...
    <div class="form-group">
        <label for="dark_mode_pulse_background_color"><i class="fas fa-fw fa-sm fa-palette text-muted mr-1"></i> <?= l('notification.settings.pulse_background_color') ?></label>
        <input type="hidden" id="dark_mode_pulse_background_color" name="dark_mode_pulse_background_color" class="form-control" value="<?= $data->notification->settings->dark_mode_pulse_background_color ?>" />
        <div id="dark_mode_pulse_background_color_pickr"></div>
    </div>
...
<script>
    ...
    /* Light mode */
    init_color_pickr('#settings_description_color', '#settings_description_color_pickr', '.altumcode-live-counter-description', 'color', 'light', 'description');
    ...
    init_color_pickr('#settings_pulse_background_color', '#settings_pulse_background_color_pickr', '.altumcode-toast-pulse-wrapper svg g', 'fill', 'light', 'pulse_background');

    /* Dark mode */
    init_color_pickr('#dark_mode_description_color', '#dark_mode_description_color_pickr', '.altumcode-live-counter-description', 'color', 'dark', 'description');
    ...
    init_color_pickr('#dark_mode_pulse_background_color', '#dark_mode_pulse_background_color_pickr', '.altumcode-toast-pulse-wrapper svg g', 'fill', 'dark', 'pulse_background');
</script>
